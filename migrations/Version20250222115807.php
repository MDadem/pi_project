 ...
 */
final class Version20250222115807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_comment ADD user_id INT NOT NULL, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_comment ADD user DATETIME NOT NULL, DROP user_id');
    }
}
